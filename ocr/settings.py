...
SECRET_KEY = 'django-insecure-#__oi4b!t=652*ijj362mhrvn2b2!jq!vab9mvn#+mdu-r6s99'
...
#this is for allowing local host 
...
GOOGLE_APPLICATION_CREDENTIALS = 'C:\merida\pp\PROJECt\ocr_env\Scripts\ocr\key.json'
